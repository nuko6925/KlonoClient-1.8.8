...
//import klono.gui.SplashScreen;
import klono.mods.impl.TimeChangerHandler;
import klono.session.CheckMultiplayer;
import net.klono.lib.CoinCheck;
import net.klono.lib.Ping;
...
{
	public static String whatmyping = "-1";
	public static String BTC = "Checking...";
	public static boolean sended = false;
	public static Long lastsend = 0L;
	public static String playing = "";
	public static int www = 0;
	public static int tps = 0;
	public static Long ms = 0L;
	public static ServerData onserver = null;
...
//        SplashScreen.drawSplash(getTextureManager());
        ...
        this.fontRendererObj = new FontRenderer(gameSettings, new ResourceLocation("textures/font/ascii.png"), this.renderEngine, false);
        ...
        AchievementList.openInventory.setStatStringFormatter(new IStatStringFormat()
        {
            public String formatString(String p_74535_1_)
            {
                try
                {
                    return String.format(p_74535_1_, new Object[] {GameSettings.getKeyDisplayString(Minecraft.gameSettings.keyBindInventory.getKeyCode())});
                }
    ...
    {
        return this.mcLanguageManager.isCurrentLocaleUnicode() || gameSettings.forceUnicodeFont;
    }
    ...
    private void runGameLoop() throws IOException
    {
        ...
        while (getSystemTime() >= this.debugUpdateTime + 1000L)
        {
            ...
            this.debug = String.format("%d fps (%d chunk update%s) T: %s%s%s%s%s", new Object[] {Integer.valueOf(debugFPS), Integer.valueOf(RenderChunk.renderChunksUpdated), RenderChunk.renderChunksUpdated != 1 ? "s" : "", (float)gameSettings.limitFramerate == GameSettings.Options.FRAMERATE_LIMIT.getValueMax() ? "inf" : Integer.valueOf(gameSettings.limitFramerate), gameSettings.enableVsync ? " vsync" : "", gameSettings.fancyGraphics ? "" : " fast", gameSettings.clouds == 0 ? "" : (gameSettings.clouds == 1 ? " fast-clouds" : " fancy-clouds"), OpenGlHelper.useVbo() ? " vbo" : ""});
    ...
    {
        return this.theWorld == null && this.currentScreen != null ? 30 : gameSettings.limitFramerate;
    }
 ...
 //           Display.setFullscreen(this.fullscreen);
    ...
    public void runTick() throws IOException
    {
    	if (Minecraft.getMinecraft().thePlayer != null) {
			if (Minecraft.getMinecraft().theWorld != null) {
				if (Minecraft.getMinecraft().currentScreen == null || Minecraft.getMinecraft().currentScreen instanceof GuiContainer || Minecraft.getMinecraft().currentScreen instanceof GuiChat) {
					if (Minecraft.www < 200) {
						Minecraft.www += 1;
					} else {
						try {
							if (Minecraft.getMinecraft().getNetHandler().getPlayerInfo(Minecraft.getMinecraft().thePlayer.getUniqueID()).getResponseTime() == 1) {
								Minecraft.getMinecraft().thePlayer.sendChatMessage("/"+Math.random());
						...
						CoinCheck coinCheck = new CoinCheck();
						coinCheck.start();
						//SessionAPI.checkUsers();
						if (SessionAPI.canConnect.equals("")) {
							SessionAPI.testSession();
						} else {
							SessionAPI.checknetwork();
						}
						Minecraft.www = 0;
					}
				}
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                klono.event.impl.KeyEvent event = new klono.event.impl.KeyEvent(k);
                event.call();
            ...
            if (this.currentScreen == null && gameSettings.keyBindCommand.isPressed() && flag)
            {
                this.displayGuiScreen(new GuiChat("/"));
            }
            ...
            if (gameSettings.keyBindUseItem.isKeyDown() && this.rightClickDelayTimer == 0 && !this.thePlayer.isUsingItem())
            {
                this.rightClickMouse();
            }
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn)
    {
        ...
        Client.getInstance().getDiscordRP().update("Playing", "SinglePlayer");
        CheckMultiplayer.raw_ip = "";
    }
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage)
    {
        ...
        if (worldClientIn != null)
        {
            ...
            this.thePlayer.movementInput = new MovementInputFromOptions(gameSettings);
    ...
    public CrashReport addGraphicsAndWorldToCrashReport(CrashReport theCrash)
    {
        ...
        theCrash.getCategory().addCrashSectionCallable("Resource Packs", new Callable<String>()
        {
            public String call() throws Exception
            {
                ...
                for (Object s : Minecraft.gameSettings.resourcePacks)
                {
                    ...
                    if (Minecraft.gameSettings.field_183018_l.contains(s))
                    {
