...
public class Gui
{
    public static final ResourceLocation optionsBackground = new ResourceLocation("klono/gui/options_background.png");//default:textures/gui/options_background.png
