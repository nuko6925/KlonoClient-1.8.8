...
public class GuiIngame extends Gui
{
    ...
    private void renderPlayerStats(ScaledResolution p_180477_1_)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            if (ModMurder.state) {
            	RainbowWave.drawStringWaveShadow("Armor: "+k2+"/20", i1, j2);
            } else {
            ...
            if (ModMurder.state) {
            	RainbowWave.drawStringWaveShadow("HP: "+LevelHead.getLevel(mc.thePlayer.getName())+"/"+(mc.thePlayer.getMaxHealth() + mc.thePlayer.getAbsorptionAmount()), i1, k1);
            } else {
            ...
            if (ModMurder.state) {
            	if (entity == null) {
            		RainbowWave.drawStringWaveShadow("Food: "+k+"/20", j1 - 81, k1);
            	} else if (entity instanceof EntityLivingBase) {
            		EntityLivingBase entitylivingbase = (EntityLivingBase)entity;
	                int l7 = (int)Math.ceil((double)entitylivingbase.getHealth());
	                float f3 = entitylivingbase.getMaxHealth();
            		RainbowWave.drawStringWaveShadow(entity.getName()+": "+LevelHead.format.format(l7)+"/"+f3, j1 - 81, k1);
            	}
            } else {
