...
public class GuiOverlayDebug extends Gui
{
    ...
    {
        this.debugRendererChunkBorder = new DebugRendererChunkBorder(mc);
		this.mc = mc;
    ...
    public void renderDebugInfo(ScaledResolution scaledResolutionIn)
    {
        ...
        this.debugRendererChunkBorder.render();
    }
...
//                RainbowWave.drawStringWave(s, 2, l);
//                this.fontRenderer.drawString(s, 2, l, Color.HSBtoRGB((float)((System.currentTimeMillis() - long1) % 10000L) / 10000L, 0.8F, 0.8F));
                long1 += 500L;
...
//                RainbowWave.drawStringWave(s, l, i1);
//                this.fontRenderer.drawString(s, l, i1, Color.HSBtoRGB((float)((System.currentTimeMillis() - long1) % 10000L) / 10000L, 0.8F, 0.8F));
                long1 += 500L;
