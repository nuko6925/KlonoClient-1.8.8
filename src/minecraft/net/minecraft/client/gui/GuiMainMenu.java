...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private void drawPanorama(int p_73970_1_, int p_73970_2_, float p_73970_3_)
    {
        ...
        GlStateManager.pushMatrix();
        GlStateManager.loadIdentity();
        GlStateManager.color(0.0F, 1.0F, 0.8F, 1.0F);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        GlStateManager.popMatrix();
        String s = ClientInfo.Client_Name + " "+ClientInfo.Client_Version;
        ...
        this.drawString(this.fontRendererObj, "PluginLoader "+PluginLoader.version, 2, this.height - 30, -1);
        this.drawString(this.fontRendererObj, s, 2, this.height - 20, -1);
        this.drawString(this.fontRendererObj, PluginLoader.plugins_name.size()+" plugin loaded", 2, this.height - 10, -1);
//        this.drawString(this.fontRendererObj, s, 2, this.height - 10, -1);
        String s1 = "Developer: Arisfiel, p_X1_a  ";
