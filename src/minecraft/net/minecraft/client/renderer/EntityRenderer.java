...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping())
        {
            ...
            if (!this.mc.gameSettings.debugCamEnable)
            {
                ...
                GlStateManager.rotate(ModInstances.getFreeLook().getCameraYaw() + (ModInstances.getFreeLook().getCameraYaw() - ModInstances.getFreeLook().getCameraYaw()) * partialTicks + 180.0F, 0.0F, -1.0F, 0.0F);
                GlStateManager.rotate(ModInstances.getFreeLook().getCameraPitch() + (ModInstances.getFreeLook().getCameraPitch() - ModInstances.getFreeLook().getCameraPitch()) * partialTicks, -1.0F, 0.0F, 0.0F);
            }
        }
        else if (this.mc.gameSettings.thirdPersonView > 0)
        {
            ...
            {
                float f1 = ModInstances.getFreeLook().getCameraYaw();
                float f2 = ModInstances.getFreeLook().getCameraPitch();
                ...
                GlStateManager.rotate(ModInstances.getFreeLook().getCameraPitch() - f2, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(ModInstances.getFreeLook().getCameraYaw() - f1, 0.0F, 1.0F, 0.0F);
                GlStateManager.translate(0.0F, 0.0F, (float)(-d3));
                GlStateManager.rotate(f1 - ModInstances.getFreeLook().getCameraYaw(), 0.0F, 1.0F, 0.0F);
                GlStateManager.rotate(f2 - ModInstances.getFreeLook().getCameraPitch(), 1.0F, 0.0F, 0.0F);
            }
        }
        else
        {
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists())
        {
            if (!this.mc.gameSettings.debugCamEnable)
            {
                float f6 = ModInstances.getFreeLook().getCameraYaw() + (ModInstances.getFreeLook().getCameraYaw() - ModInstances.getFreeLook().getCameraYaw()) * partialTicks + 180.0F;
                float f7 = ModInstances.getFreeLook().getCameraPitch() + (ModInstances.getFreeLook().getCameraPitch() - ModInstances.getFreeLook().getCameraPitch()) * partialTicks;
                float f8 = 0.0F;
    ...
    public void func_181560_a(float p_181560_1_, long p_181560_2_)
    {
        ...
        if (this.mc.inGameHasFocus && flag  && ModInstances.getFreeLook().overrideMouse())
        {
