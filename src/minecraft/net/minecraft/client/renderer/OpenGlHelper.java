...
public class OpenGlHelper
{
    ...
    {
        return Config.isMultiTexture() ? false : vboSupported && GameSettings.useVbo;
    }
    ...
    {
        return Config.isFastRender() ? false : (Config.isAntialiasing() ? false : framebufferSupported && GameSettings.fboEnable);
    }
