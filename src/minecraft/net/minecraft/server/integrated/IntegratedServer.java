...
public class IntegratedServer extends MinecraftServer
{
    ...
    public void tick()
    {
        ...
        else
        {
            ...
            {
                logger.info("Changing view distance to {}, from {}", new Object[] {Integer.valueOf(GameSettings.renderDistanceChunks), Integer.valueOf(this.getConfigurationManager().getViewDistance())});
                this.getConfigurationManager().setViewDistance(GameSettings.renderDistanceChunks);
            }

            if (Minecraft.theWorld != null)
            {
                WorldInfo worldinfo = this.worldServers[0].getWorldInfo();
                WorldInfo worldinfo1 = Minecraft.theWorld.getWorldInfo();
